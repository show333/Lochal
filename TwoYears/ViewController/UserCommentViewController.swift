...
//        if let url = URL(string: "gs://totalgood-7b3a3.appspot.com/ChatRoom_image/F81F5718-34B6-404E-A304-8B442B9E2FB7") {
//            Nuke.loadImage(with: url, into: userBackImageView!)
//        }
...
//                cell.messageLabel.backgroundColor = #colorLiteral(red: 0.721568644, green: 0.8862745166, blue: 0.3487654059, alpha: 0.7998983305)
//            }
//            if animals[indexPath.row].membersCount >= 2 && animals[indexPath.row].userId != uid{
