...
class sinkitoukou: UIViewController {
    ...
    private func lulu(teamName: String) {
        ...
        //                    ["message" : thisisMessage as Any, uid:uid, "createdAt":Timestamp(),]
...
//            print("companyId",company1Idget)
//            print(self.company1Id ?? nil)
//            print(self.companyId?)
//            print("ビューカウント！！！！",document.data()?["company1"] as? String?)
...
//        #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.8430276113)
