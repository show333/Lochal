...
//
//
//        self.ChatRoomViewController()?.present(imagePickerController, animated: true, completion: nil)
...
//extension ChatInputAccessoryView: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
//
...
//        self.ChatRoomViewController()?.dismiss(animated: true, completion: nil)
//    }
//}
